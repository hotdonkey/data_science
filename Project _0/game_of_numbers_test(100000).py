...
def random_predict(number:int=np.random.randint(1, 100001)) -> int:
    ...
    """
    count = 0
    upper = 100001                                             #upper border of the generated list
...
def score_game(random_predict) -> int:
    ...
    random_array = np.random.randint(1, 100001, size=(1000))     #ammount of cycles to find the number in the stated range
